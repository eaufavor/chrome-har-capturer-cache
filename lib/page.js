            ...
            case 'Network.dataReceived':
                if (id in self.objects) {
                    ...
                    if (!self.objects[id].cached) {
                        ...
                        {
                            'timestamp': ((message.params.timestamp - self.objects[id].responseMessage.timestamp) + (self.objects[id].responseMessage.response.timing.receiveHeadersEnd - self.objects[id].responseMessage.response.timing.requestTime))*1000,
