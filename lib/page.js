            ...
            case 'Network.dataReceived':
                if (id in self.objects) {
                    ...
                    if (!self.objects[id].cached) {
                        ...
                        {
                            'timestamp': (message.params.timestamp - self.objects[id].responseMessage.timestamp)*1000 + (self.objects[id].responseMessage.response.timing.receiveHeadersEnd - self.objects[id].responseMessage.response.timing.requestTime),
