...
Page.prototype.processMessage = function (message) {
            ...
            case 'Network.dataReceived':
                if (id in self.objects) {
                    ...
                    if (!self.objects[id].cached) {
                        ...
                        {
                            'timestamp': (message.params.timestamp - self.objects[id].responseMessage.timestamp)*1000 + self.objects[id].responseMessage.response.timing.receiveHeadersEnd,
    ...
    if (typeof id === 'undefined') {
        ...
        if (typeof self.objects[id].requestMessage != 'undefined'){
