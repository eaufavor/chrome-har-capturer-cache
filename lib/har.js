...
function fromPage(page) {
    ...
    for (var requestId in page.objects) {
		...
		var startTime = object.cached ? object.requestMessage.timestamp*1000 : timing.requestTime;
        ...
        entries.push({
            ...
            'time': object.cached ? 0 : totalTime,
            'request': {
            ...
            'cache': {},
            'timings': {
                'blocked': object.cached ? 0 : blocked, // Is it right?
                'dns': object.cached? -1 : dnsTime,
                'connect': object.responseMessage.response.connectionReused || object.cached ? -1 : connectTime,
                'send': object.cached ? 0 : sendTime,
                'wait': object.cached ? 0 : waitTime,
                'receive': object.cached ? 0 : receiveTime,
                'ssl': object.cached ? -1 : sslTime
            },
