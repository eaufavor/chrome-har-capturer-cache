                                    ...
                                    loadEventTimeout = setTimeout(function () {
                                        ...
                                        // TODO: inject RT data here:
                                         for (var requestId in page.objects) {
                                            ...
                                            chrome.Runtime.evaluate({'expression': "performance.performance.getEntriesByName("+obj_url+").responseEnd", 'returnByValue': true}, function (e, r){
                                                common.dump('--- RT: responseEnd: '+ r.result.value + " resFinMs: " + object.responseFinishedMs + ' for ' + obj_url);
                                            });
                                        }
